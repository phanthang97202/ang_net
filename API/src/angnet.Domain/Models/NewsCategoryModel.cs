...
namespace angnet.Domain.Models
{
    public class NewsCategoryModel : BaseModel
    {
        ...
        [Required]
        public string NewsCategoryName { get; set; } = string.Empty; // Tên danh mục bài viết tiếng Việt
        [Required]
        public string NewsCategoryNameEn { get; set; } = string.Empty; // Tên danh mục bài viết tiếng Anh
