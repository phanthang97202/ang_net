...
namespace API.Infrastructure.Data.Persistences.Migrations
{
    ...
    [Migration("20250623074115_MultiTenancyForApp")]
    partial class MultiTenancyForApp
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("API.API.Models.AppUser", b =>
                {
            ...
            modelBuilder.Entity("SharedModels.Models.MstTenantContactModel", b =>
                {
            ...
            modelBuilder.Entity("SharedModels.Models.OrderStadiumModel", b =>
                {
                    b.Property<string>("OrderStadiumId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("SharedModels.Models.TenantModel", b =>
                {
                    b.Property<string>("TenantId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("API.API.Models.AppUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("SharedModels.Models.MstTenantContactModel", b =>
                {
                    b.HasOne("SharedModels.Models.TenantModel", null)
                        .WithMany()
