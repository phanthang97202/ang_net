...
namespace angnet.Application.Interfaces.Repositories
{
    ...
    {
        public Task<ApiResponse<RPNewsDto>> Search(int pageIndex, int pageSize, string keyword, string userId, string categoryId, bool onlyPublished = true, string hashTag = "");
